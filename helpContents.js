...
<html>
  ...
  * The third block is an <a href="https://www.inklestudios.com/ink/">Ink</a> script
  ...
  <h2>Tiles with knots</h2>

  Tiles can also trigger a knot when a player steps on them. Just define a "knot" property for the tile
  and set pass to "yes":

    <pre>
      title:      title: Smelly Game, author: Me
      1:          show: no, knot: stink, pass: yes
    ...
    This way, you can have several tiles that all show the same text when the player walks over them.
